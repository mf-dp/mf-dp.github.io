              ...
              {groupedArticles.journals.map((article: any, index: number) => {
                ...
                return (
                  <motion.div key={`journal-${index}`} variants={itemVariants}>
                    <Card className="overflow-hidden min-h-[550px] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl flex flex-col border-gray-200 shadow-md bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 dark:border-gray-700">
