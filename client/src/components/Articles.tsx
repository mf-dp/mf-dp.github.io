              ...
              {groupedArticles.journals.map((article: any, index: number) => {
                ...
                return (
                  <motion.div key={`journal-${index}`} variants={itemVariants}>
                    <Card className="overflow-hidden h-full transition-all duration-300 hover:-translate-y-1 hover:shadow-xl flex flex-col border-gray-200 shadow-md bg-blue-50 dark:bg-gray-800 dark:border-gray-700">
